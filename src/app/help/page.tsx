        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 36 }}>
          ...
          <Section title="🗺️ 基本的な使い方">
            ...
            <Q q="投票ページを作るにはどうすればいいですか？">
              トップページでタイトル・幹事名・候補の場所を入力して「投票ページを作成する」ボタンを押してください。作成後に表示されるURLを参加者に共有します。FLOW YOTEIで日程調整をしている場合はそのURLも紐付けられます。
            </Q>
            <Q q="参加者はどうやって投票しますか？">
              共有されたURLを開き、名前を入力して各候補に🙆（行きたい）🤔（行けなくはない）🙅（遠慮したい）を選びます。さらに「🏆 イチ推し」を1つ選べます（任意）。アカウント登録は不要です。
            </Q>
            <Q q="イチ推しとは何ですか？">
              🙆🤔🙅の投票とは別に、一番行きたい場所を1つだけ選べる機能です。🙆が同じ数の候補がある場合にイチ推しの数が多い順で上位表示されます。集計テーブルでも🏆マークで確認できます。
            </Q>
          ...
          <Section title="➕ 候補の追加・編集">
            ...
            <Q q="タイトルや締切、YOTEI URLを変更できますか？">
              できます。投票ページのタイトル横の「✏️ 編集」ボタンからタイトル・締切・FLOW YOTEI URLを変更できます。
            </Q>
          </Section>
